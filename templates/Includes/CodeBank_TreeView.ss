...
<div class="center">
	...
	<div class="cms-tree codebank-tree draggable" data-url-tree="$Link(getsubtree)" data-url-updatetreenodes="$Link(updatetreenodes)" data-url-addsnippet="admin/codeBank/addToLanguage?ID=%s&amp;ClassName=%s&amp;SecurityID=$SecurityID" data-url-addfolder="admin/codeBank/addFolder?ParentID=%s&amp;SecurityID=$SecurityID" data-url-renamefolder="admin/codeBank/renameFolder/?ID=%s&amp;SecurityID=$SecurityID" data-url-deletefolder="admin/codeBank/deleteFolder/?ID=%s&amp;SecurityID=$SecurityID" data-url-editscreen="$Link('edit')/show/%s" data-url-savetreenode="admin/codeBank/moveSnippet/" data-hints="$TreeHints">
		$SiteTreeAsUL
	</div>
</div>
